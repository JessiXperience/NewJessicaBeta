...
public class ItemRenderer
{
    ...
    private void transformSideFirstPerson(EnumHandSide p_187459_1_, float p_187459_2_, float f3)
    {
    	boolean bl = SwingAnimate.a(p_187459_1_);
        int i = p_187459_1_ == EnumHandSide.RIGHT ? 1 : -1;
        float x = (float)i * 0.56f;
        float y = -0.52f + p_187459_2_ * -0.6f;
        float z = -0.72f;
        //GlStateManager.translate((float)i * 0.56F, -0.52F + p_187459_2_ * -0.6F, -0.72F);
        if (bl) {
            GlStateManager.translate((float)x, (float)0.312f, (float)z);
        } else {
    ...
    public void renderItemInFirstPerson(float partialTicks)
    {
        ...
        if (flag)
        {
            ...
            if (ModuleManager.getModule("ViewModel").isToggled()) {
                GlStateManager.translate(ViewModel.rightx.getDoubleValue() - 1.0, ViewModel.righty.getDoubleValue() - 1.0, ViewModel.rightz.getDoubleValue() - 1.0);
            }
        ...
        if (flag1)
        {
            ...
            GlStateManager.pushMatrix();
            if (ModuleManager.getModule("ViewModel").isToggled()) {
                GlStateManager.translate(ViewModel.leftx.getDoubleValue() - 1.0, ViewModel.lefty.getDoubleValue() - 1.0, ViewModel.leftz.getDoubleValue() - 1.0);
            }
    ...
    public void renderItemInFirstPerson(AbstractClientPlayer p_187457_1_, float p_187457_2_, float p_187457_3_, EnumHand p_187457_4_, float p_187457_5_, ItemStack itemStack, float p_187457_7_)
    {
        if (!Config.isShaders() || !Shaders.isSkipRenderHand(p_187457_4_))
        {
            ...
            else if (itemStack.getItem() instanceof ItemMap)
            {
                ...
                {
                    this.renderMapFirstPersonSide(p_187457_7_, enumhandside, p_187457_5_, itemStack);
                }
            }
            else
            {
                ...
                if (p_187457_1_.isHandActive() && p_187457_1_.getItemInUseCount() > 0 && p_187457_1_.getActiveHand() == p_187457_4_)
                {
                    ...
                    {
                        case NONE:
                            this.transformSideFirstPerson(enumhandside, p_187457_7_, p_187457_5_);
                            break;

                        case EAT:
                        case DRINK:
                            this.transformEatFirstPerson(p_187457_2_, enumhandside, itemStack);
                            this.transformSideFirstPerson(enumhandside, p_187457_7_, p_187457_5_);
                            break;
                        ...
                        case BOW:
                            ...
                            float f5 = (float)itemStack.getMaxItemUseDuration() - ((float)this.mc.player.getItemInUseCount() - p_187457_2_ + 1.0F);
                            float f6 = f5 / 20.0F;
                ...
                else
                {
                    ...
                    if(SwingAnimate.a(enumhandside)) {
                    	if(SwingAnimate.mode.getValue().equalsIgnoreCase("Block")) {
                    		SwingAnimate.g.a(p_187457_5_ > 0.0f);
                    		this.transformSideFirstPerson(enumhandside, p_187457_7_, p_187457_5_);
                    		SwingAnimate.blockAnimation(enumhandside, (float)SwingAnimate.g.b());
                    	} else if(SwingAnimate.mode.getValue().equalsIgnoreCase("Swing")) {
                    		SwingAnimate.swingAnimation(p_187457_5_);
                    	} else if(SwingAnimate.mode.getValue().equalsIgnoreCase("Break")) {
                    		SwingAnimate.breakAnimation(p_187457_5_);
                    	} else if(SwingAnimate.mode.getValue().equalsIgnoreCase("Tap")) {
                    		SwingAnimate.tapAnimation(p_187457_5_);
                    	} else if(SwingAnimate.mode.getValue().equalsIgnoreCase("Slap")) {
                    		SwingAnimate.slapAnimation(f1);
                    	}
                    } else {
                ...
                this.renderItemSide(p_187457_1_, itemStack, flag1 ? ItemCameraTransforms.TransformType.FIRST_PERSON_RIGHT_HAND : ItemCameraTransforms.TransformType.FIRST_PERSON_LEFT_HAND, !flag1);
            }
