...
public class GuiMultiplayer extends GuiScreen
{
    ...
    public void createButtons()
    {
        ...
        this.buttonList.add(new GuiButton(10, this.width / 2 + 4 - 259, this.height - 52, 75, 20, I18n.format("BungeeHack")));
        this.buttonList.add(new GuiButton(11, this.width / 2 + 4 - 259, this.height - 28, 75, 20, I18n.format("UUID Spoof")));
