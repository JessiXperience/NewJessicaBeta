                    ...
                    if (chatline != null)
                    {
                        ...
                        if (j1 < 200 || flag)
                        {
                            ...
                            if (l1 > 3)
                            {
                                ...
                                int customwidth = 0 + k + 4;
                                if(ModuleManager.getModule("CustomChat").isToggled()) {
                                	int width = Wrapper.FONT_MANAGER.TrebuchetMS.getStringWidth(s);
                                	if (width > customwidth) {
                                		customwidth = width + 3;
                                    }
                                	RenderUtils.drawRect(-2.0, j2 - 8.5, customwidth, j2 + 0.5, l1 / 2 << 24);
                                } else {
                                	drawRect(-2, j2 - 9, 0 + k + 4, j2, l1 / 2 << 24);
                                }
                                GlStateManager.enableBlend();
                                if(ModuleManager.getModule("CustomChat").isToggled()) {
                                	Wrapper.FONT_MANAGER.TrebuchetMS.drawString(s, 0.0F, j2 - 7, 16777215 + (l1 << 24));
                                } else {
