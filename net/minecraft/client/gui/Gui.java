...
public class Gui
{
    ...
    public void drawCenteredStringWithFont(CFontRenderer fontrenderer, String text, int x, int y, int color)
    {
    	Wrapper.FONT_MANAGER.JetBrLight.drawStringWithShadow(text, (float)(x - fontrenderer.getStringWidth(text) / 2), (float)y, color);
    }
    ...
    public void drawStringWithFont(FontRenderer fontRendererIn, String text, int x, int y, int color)
    {
    	Wrapper.FONT_MANAGER.JetBrLight.drawStringWithShadow(text, (float)x, (float)y, color);
    }
