...
import jessica.events.ClientTickEvent.Phase;
...
public class Minecraft implements IThreadListener, ISnooperInfo
{
     ...
     */
    private void startGame() throws LWJGLException, IOException, FontFormatException
    {
    ...
    private void createDisplay() throws LWJGLException
    {
        ...
        Display.setTitle(Wrapper.getClientName());
    ...
    public void runTick() throws IOException
    {
        ...
        ClientTickEvent eventPre = new ClientTickEvent(Phase.START);
        ModuleManager.onClientTick(eventPre);
        ...
        ClientTickEvent eventPost = new ClientTickEvent(Phase.END);
        ModuleManager.onClientTick(eventPost);
