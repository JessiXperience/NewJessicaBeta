...
import jessica.events.PlayerTickEvent.Phase;
...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    {
    	PlayerTickEvent eventPre = new PlayerTickEvent(Phase.START, this);
        ModuleManager.onPlayerTick(eventPre);
        ...
        PlayerTickEvent eventPost = new PlayerTickEvent(Phase.END, this);
        ModuleManager.onPlayerTick(eventPost);
    }
